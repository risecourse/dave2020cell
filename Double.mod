NEURON {
	...
	RANGE onset, tau1,tau2, gmax,B,enmda,inmdaC, r, r0, r1, lastrelease,TimeCount,rinf,rtau,gnmda
...
BREAKPOINT {
	...
	gnmda = gmax*((tau1*tau2)/(tau1-tau2))*duale((t-onset)/tau1,(t-onset)/tau2)*B
